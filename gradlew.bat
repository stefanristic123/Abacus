...
<project version="4">
  ...
  <component name="ChangeListManager">
    <list default="true" id="1a19ae3b-c0c2-4e95-9be5-f038afceb983" name="Default" comment="" />
  ...
  <component name="FileEditorManager">
    <leaf SIDE_TABS_SIZE_LIMIT_KEY="300">
      ...
      <file leaf-file-name="MainActivity.java" pinned="false" current-in-tab="false">
        <entry file="file://$PROJECT_DIR$/app/src/main/java/com/example/stefan/taksi/MainActivity.java">
  ...
  <component name="GradleLocalSettings">
    <option name="myGradleHomes">
      <map>
        <entry key="$PROJECT_DIR$" value="C:\Users\Stefan\.gradle\wrapper\dists\gradle-4.6-a